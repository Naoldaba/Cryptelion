        ...
        {chartDataState.length === 0 ? (
            ...
            <div className="statsCardHold boxsh2 rounded">
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    ${specificCrytpCoinData.market_data.current_price.usd.toLocaleString()}
                    </p>
                </div>
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    <p className={`${specificCrytpCoinData.market_data.price_change_24h > 0 ? "text-green-500 text-lg font-semibold" : "text-red-500 text-lg font-semibold"}`}>
                    ${Math.floor(specificCrytpCoinData.market_data.price_change_24h).toLocaleString()}
                    </p>
                </div>
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    <p className='font-semibold'>
                    ${specificCrytpCoinData.market_data.ath.usd.toLocaleString()}
                    </p>
                </div>
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    <p className='font-semibold'>
                    ${specificCrytpCoinData.market_data.atl.usd.toLocaleString()}
                    </p>
                </div>
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    <p className='font-semibold'>
                    ${specificCrytpCoinData.market_data.total_volume.usd.toLocaleString()}
                    </p>
                </div>
                ...
                <div className='flex justify-between w80Perc gap-2'>
                    ...
                    <p className='font-semibold'>
                    #{specificCrytpCoinData.market_cap_rank}
                    </p>
                </div>
                ...
                {specificCrytpCoinData.description.en.length > 20 && (
                    ...
                    <p className='font-semibold'>
                        {specificCrytpCoinData.description.en.substring(0, 250)}
                        <Link
                        target="_blank"
                        href={specificCrytpCoinData.links.homepage[0]}
